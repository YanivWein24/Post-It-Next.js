...
export default function DeleteModal({ postId, setIsModalOpen }: ToggleProps) {
  ...
  return (
    ...
    >
      <div className="absolute bg-white w-11/12 sm:w-fit w-clear top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-8 sm:p-12 rounded-lg flex flex-col gap-6">
